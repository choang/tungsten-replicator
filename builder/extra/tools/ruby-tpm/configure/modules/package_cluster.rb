...
Optionally, you can start the replicator in the foreground.  You may need to
run in the foreground, for instance, when you create a Docker image, and need
to use the start script as the entrypoint.

  WRAPPER_DAEMONIZE=FALSE #{root}/tungsten/cluster-home/bin/startall

Expect logs to be written to console when running in the foreground.
